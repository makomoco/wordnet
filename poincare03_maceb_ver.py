...
distance_and_word_list_hukugougo = [['状態表示',0.7861080035099905],
                                    ['ロックランプ',3.4193208611866024],
                                    ['ポンプ',10.158806403323792],
                                    ['温度制御',0.26675220818771983],
                                    ['沸騰ボタン',10.475748046199035],
                                    ['温度制御方式',0.8754122811226502],
                                    ['温度制御テーブル方式',1.2445454596465897],
                                    ['沸騰',11.424656451583653],
                                    ['高温モード',2.27821317806947],
                                    ['節約モード',0.16843167788701552],
                                    ['ミルクモード',0.07997333800440233],
                                    ['センサ',10.57936080429842],
                                    ['蓋センサ',0.43173430373722466],
                                    ['沸騰ランプ',2.452639002585924],
                                    ['温度表示',1.2457106114917664],
                                    ['モード表示',1.4750406678625425],
                                    ['加熱',10.52386588053033],
                                    ['水位検知',1.151991689681557],
                                    ['水位メータ',0.009690482362774486],
                                    ['水位センサ',0.6534839647192356],
                                    ['エラー検知',1.3134649070610038],
                                    ['高温エラー',1.3369774421893466],
                                    ['分追加',2.231547416467637]]
